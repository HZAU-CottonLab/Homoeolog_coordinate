...
LastEditors: zpliu
LastEditTime: 2021-07-04 16:06:55
@param: 
'''
...
def run_lastz_result(geneRegionPairList, homoeologGeneCoordinate: list, genomeObject):
    ...
    for pairedRegion in geneRegionPairList:
        ...
        try:
            ...
            print(pairedRegion)
            continue
        out += parse_lastz_cigra(pairedRegion, cigraFlag,
...
def parse_lastz_cigra(pairedRegion, cigraFlagstr, homoeologGeneCoordinate):
    ...
    if cigraFlagstr:
        ...
        for flag in cigraList:
            ...
            cigarFlag = flag.split(" ")[10:-1:2]
            cigarBase = flag.split(" ")[11:-1:2]
            # print(cigarFlag)
            # print(cigarBase)
...
def calcuate_coordinate(cigarFlag, cigarBase, inputData):
    ...
    '''
    out = []
    chromAt, chromDt, Atstart, Dtstart, AtgeneId, Atstand, DtgeneId, Dtstand, Atmultiple, Dtmultiple, Direction = inputData
...
if __name__ == "__main__":
    ...
    homoeologGeneInfo = pd.DataFrame(
        [['Ghir_A01', 68889, 76180, 'Ghir_A01G000040', '-', 'Ghir_D01', 38781, 46323, 'Ghir_D01G000060', '+']])
